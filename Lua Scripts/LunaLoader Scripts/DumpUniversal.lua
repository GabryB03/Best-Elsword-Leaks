--FuncDumper, it'll dump the functions in funclist who'r loaded.
local outfile = "_fdResult.txt"
local funclist = {
	{"Table", "Function"}, --Here the Table + Function who you want, you can dump more then one in one execution.
}
