--{ "Name":"Ultimate Title Mod 2","Author": "Jenova", "Type":"General Dungeon", "Version": "1.0" }
--Title Ultimate Combo by ~JenovaOnline~
--Execute before Elsword if fully loaded, this is a example for editing titles.
